# Python 3
# BIT90 WAV file decoder v1.1
# The input file should be a raw file type PCM 8-bit unsiged 44100Hz mono
# Modified version for Demo1.raw decoding.. skip the first 2 decoded bytes
...
try:
    ...
    with open(filename + '.raw', 'rb') as f, open(filename + '.bin', 'wb') as w:
        ...
        skipbytes = 2		# discard this number of bytes from the start
